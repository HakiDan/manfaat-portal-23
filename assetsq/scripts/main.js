/*! For license information please see main.js.LICENSE */ ! function(e) {
    ...
    ! function(t, n) {
        ...
        var S = function(e) {
            ...
            function Ce(e, t, n, r, i, o) {
                return r && !r[x] && (r = Ce(r)), i && !i[x] && (i = Ce(i, o)), le(function(o, a, s, u) {
                    ...
                    } else m = Te(m === a ? m.splice(h, m.length) : m), i ? i(null, a, m, u) : L.apply(a, m)
                })
            }
                        ...
                        var n = t.length > 0,
                            ...
                            o = function(o, a, s, u, c) {
                                ...
                                if (m += y, n && y !== m) {
                                    ...
                                    L.apply(u, x), c && !o && x.length > 0 && m + t.length > 1 && se.uniqueSort(u)
                                }
                                return c && (T = k, l = w), b
                            };
                        return n ? le(o) : o
        ...
        function Me(e, t, n, r) {
            ...
            if (d && (o = (i = xe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                for (s = (a = C.map(me(i, "script"), Le)).length; f < d; f++) l = i, f !== p && (l = C.clone(l, !0, !0), s && C.merge(a, me(l, "script"))), n.call(e[f], l, f);
                if (s)
        ...
        Rt.href = Tt.href, C.extend({
            ...
            ajax: function(e, t) {
                ...
                for (f in (c = C.event && p.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Ht.test(p.type), i = p.url.replace(Nt, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(At, "+")) : (d = p.url.slice(i.length), p.data && (p.processData || "string" == typeof p.data) && (i += (kt.test(i) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (i = i.replace(Ot, "$1"), d = (kt.test(i) ? "&" : "?") + "_=" + Ct.guid++ + d), p.url = i + d), p.ifModified && (C.lastModified[i] && k.setRequestHeader("If-Modified-Since", C.lastModified[i]), C.etag[i] && k.setRequestHeader("If-None-Match", C.etag[i])), (p.data && p.hasContent && !1 !== p.contentType || t.contentType) && k.setRequestHeader("Content-Type", p.contentType), k.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Pt + "; q=0.01" : "") : p.accepts["*"]), p.headers) k.setRequestHeader(f, p.headers[f]);
    ...
    (function(e) {
        ...
        var s = function() {
            ...
            return r(t, [{
                                ...
                                if (l[h].needs.sort().toString() === this.parameters.needs[f].toString()) {
                                    for (var g in this.parameters) {
                                        if ("dependents" === g) {
                                            ...
                                            if (l[h][g].sort().toString().indexOf(m.sort().toString()) >= 0 || "NA" === l[h][g].sort().toString()) continue;
                                            v = !1;
                                            break
                                        }
                                        if ("needs" !== g) {
                ...
                key: "mapIncomeLabel",
                value: function(e) {
                    return e < 1170 ? "RM0 - RM1,169" : e < 1801 ? "RM1,170 - RM1,800" : e < 2501 ? "RM1,801 - RM2,500" : e < 5001 ? "RM2,501 - RM5,000" : e < 7001 ? "RM5,001 - RM7,000" : "> RM7,000"
                }
            }, {
                key: "mapPersonalIncome",
                value: function(e) {
                    return e < 1170 ? "I7LO1" : e < 1801 ? "I7LO2" : e < 2501 ? "I7LO3" : e < 5001 ? "I7LO4" : e < 7000 ? "I7MID1" : "I7HI1"
                }
            }, {
                key: "mapHouseholdIncome",
                value: function(e) {
                    return e < 1170 ? "I8LO1" : e < 1801 ? "I8LO2" : e < 2501 ? "I8LO3" : e < 5001 ? "I8LO4" : e < 7000 ? "I8MID1" : "I8HI1"
                }
            }]), t
        }();
        t.default = s
    ...
    window.onload=function() {  //------------------------------------------------------------------save salary (bujang/berkahwin)
        if((localStorage.getItem("storeMarryStats") == "I4SGL")){
            (0, r.default)("input[name=personalEarning]").parent().fadeIn(300).addClass("active")
        }

        if((localStorage.getItem("storeMarryStats") == "I4MRD")){
            (0, r.default)("input[name=householdEarning]").parent().fadeIn(300).addClass("active")
        }
    }
    ...
    var a = function() {
        function e(t) {
            ...
            var o = (0, i.default)('<div class="eyd-custom-select__custom-dropdown" aria-hidden="true"></div>'),
                a = (0, i.default)('<button class="custom-trigger" type="button"><span class="label"></span><span class="icon fa fa-angle-down"></span></button>'),
                s = a.find(".label"),
    ...
    t.default = function e(t) {
        ...
        o.prepend(s), n.on("click", function(e) {
            ...
            n.on("change", function(e) {
                var t = [],
                    s = [];
                n.is(":checked") ? "all" == a ? ((0, r.default)('.option input[type="checkbox"]', o).prop("checked", !1), i.text("Sila pilih")) : ((0, r.default)('input[type="checkbox"][value="all"]', o).prop("checked", !1), (0, r.default)(".option", o).map(function(e, n) {
                    var i = (0, r.default)(n),
                        o = (0, r.default)("label", i).text(),
                        a = (0, r.default)("input", i).val();
                    (0, r.default)("input", i).is(":checked") && (t.push(o), s.push(a))
                }), i.text("" + t.join(", "))) : 0 == (0, r.default)('.option input[type="checkbox"]:not([value="all"]):checked', o).length ? ((0, r.default)('input[type="checkbox"][value="all"]', o).prop("checked", !0), i.text("Sila pilih")) : ((0, r.default)('input[type="checkbox"][value="all"]', o).prop("checked", !1), (0, r.default)(".option", o).map(function(e, n) {
                    var i = (0, r.default)(n),
                        o = (0, r.default)("label", i).text(),
                        a = (0, r.default)("input", i).val();
                    (0, r.default)("input", i).is(":checked") && (t.push(o), s.push(a))
