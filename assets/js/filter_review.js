...
function show_result(result, input_jenis) {
    var jenis, is_english;

    jenis = document.getElementsByClassName("tablinks active")[0].innerText
    is_english = "Rakyat Perniagaan Komuniti".indexOf(jenis) < 0
